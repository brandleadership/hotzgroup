...
export const exists = (selector, element = document) => element.querySelector(selector) !== null
...
export const getScrollPosition = (element = document.documentElement) =>
  Math.max(element.scrollTop, document.body.scrollTop, window.pageYOffset, window.scrollY)
